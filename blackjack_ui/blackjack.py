...
class BlackjackUI:
    ...
    def __init__(self):
        ...
        self.ui_start_game_button = ttk.Button(
            self.ui_title_frame, text="Jugar", state=ACTIVE, command=self.start_game)\
            .grid(column=2, row=1)
    ...
    def start_game(self):
        ...
        # self.ui_start_game_button.config(state=DISABLED)
    ...
    def end_game(self):
        ...
        # self.ui_start_game_button.config(state=ACTIVE)
